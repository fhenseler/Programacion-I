...
/** \brief  Add an element to arrayList and if
...
int al_add(ArrayList* this, void* pElement)
{
    ...
    {
        *((this->pElements) + (this->size)) = pElement; //Aritmética (los paréntesis son por claridad pero no hacen falta)
        this->size++;
        returnAux = 0;
...
/** \brief Obtains size of the arrayList
 * \param pList ArrayList* Pointer to arrayList
...
int al_sort(ArrayList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL && (order == 0 || order == 1))
    {
        ...
        for(i = 1; i < this->len(this); i++)
        {
            ...
            j = i-1;
            while(j >= 0 && pFunc(temp, this->pElements[j]) == var)
            {
...
/** \brief Filters employees from the list according to functionFilter
 * \param listIn ArrayList* Pointer to arrayList to be read and filtered
 * \param functionFilter int Pointer to filter function
 * \return ArrayList* Returns the filtered list
 *
 */
